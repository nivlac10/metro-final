...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__waiting__ = __webpack_require__(506);
...
WaitingPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-waiting',template:/*ion-inline-start:"/Users/chineduetoh/Desktop/VSCODE PROJECTS/Metro/Driver/src/pages/waiting/waiting.html"*/'<ion-header no-border>\n  <ion-navbar color="nav-color">\n    <ion-title text-center>\n        {{lp.translate()[0].l3}}\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <div [ngStyle]="{\'margin-top\': 30 + \'%\'}">\n  <h3 text-center>{{lp.translate()[0].l4}}</h3>\n  </div>\n\n  <button  class=\'button\' [ngStyle]="{\'margin-top\': 30 + \'%\'}" color="primary" ion-button block (click)="close()">\n      {{lp.translate()[0].i9}}\n</button>\n</ion-content>\n'/*ion-inline-end:"/Users/chineduetoh/Desktop/VSCODE PROJECTS/Metro/Driver/src/pages/waiting/waiting.html"*/,
    }),
