...
export class PopUpProvider {
  ...
  constructor( public act: ActivityProvider, public platform: Platform, public lp: LanguageProvider, private toastCtrl: ToastController, public storage: Storage, public cMap: NativeMapContainerProvider,  public alert: AlertController, public ph: ProfileProvider, public load: LoadingController) {
