...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reset_password__ = __webpack_require__(511);
        ...
        if (!this.resetPasswordForm.valid) {
            ...
            this.authProvider.resetPassword(this.resetPasswordForm.value.email)
                ...
                var alert = _this.alertCtrl.create({
                    message: _this.lp.translate()[0].emailsent,
                    buttons: [
                        {
                ...
                var errorAlert = _this.alertCtrl.create({
                    ...
                    buttons: [{ text: _this.lp.translate()[0].accept, role: 'cancel' }]
                });
                errorAlert.present();
            });
        }
