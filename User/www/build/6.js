...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__schedule__ = __webpack_require__(512);
...
SchedulePageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__schedule__["a" /* SchedulePage */]),
        ],
    })
], SchedulePageModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_onesignal__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_geocoder_geocoder__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_native_map_container_native_map_container__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_directionservice_directionservice__ = __webpack_require__(297);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_language_language__ = __webpack_require__(26);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SchedulePage = (function () {
    function SchedulePage(navCtrl, navParams, lp, alertCtrl, platform, ph, dProvider, cMap, gCode, One, pop, eventProvider, modalCtrl) {
    ...
    SchedulePage.prototype.ionViewDidLoad = function () {
        ...
        if (this.navParams.get('destination') != null) {
            console.log(this.navParams.get('destination'));
            this.gCode.geocoder.geocode({ 'address': this.navParams.get('destination') }, function (results, status) {
                if (status == 'OK') {
            ...
            document.getElementById("whereto").innerText = this.navParams.get('destination');
            this.destination = this.navParams.get('destination');
        }
        //console.log(this.cMap.lat, this.cMap.lng)
    ...
    SchedulePage.prototype.calcScheduleRoute = function (start, stop, destinationName, locationName, date, time) {
        ...
        this.service.getDistanceMatrix({
            ...
            if (status == 'OK') {
                ...
                var price_1 = Math.floor(response.rows[0].elements[1].distance.value / 1000) * _this.dProvider.pricePerKm + _this.dProvider.fare + fareTime;
                ...
                if (!_this.platform.is('cordova')) {
                    ...
                    _this.ph.getUserProfile().on('value', function (userProfileSnapshot) {
                        ...
                        console.log(price_1, name, image, _this.lat, _this.lng, _this.location, pay, _this.destination, _this.ph.phone, date, ratingText, ratingValue, time);
                        _this.eventProvider.CreateSchedule(price_1, name, image, _this.lat, _this.lng, _this.location, pay, _this.destination, _this.ph.phone, date, id_1, ratingText, ratingValue, time).then(function (s) {
                            _this.pop.hideLoader();
                    ...
                    _this.One.getIds().then(function (id) {
                        ...
                        _this.ph.getUserProfile().on('value', function (userProfileSnapshot) {
                            ...
                            // this.pop.showPimp(kush) 
                            console.log(price_1, name, image, _this.lat, _this.lng, _this.location, pay, _this.destination, _this.ph.phone, date);
                            _this.eventProvider.CreateSchedule(price_1, name, image, _this.lat, _this.lng, _this.location, pay, _this.destination, _this.ph.phone, date, _this.userID, ratingText, ratingValue, time).then(function (s) {
                                _this.pop.hideLoader();
