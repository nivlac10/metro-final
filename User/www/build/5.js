...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__settings__ = __webpack_require__(513);
...
SettingsPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-settings',template:/*ion-inline-start:"/Users/chineduetoh/Desktop/VSCODE PROJECTS/Metro/User/src/pages/settings/settings.html"*/'<!--\n  Generated template for the SettingsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header  no-border>\n  <ion-navbar color="nav-color">\n  <ion-title>{{lp.translate()[0].lang}}</ion-title>\n</ion-navbar>\n\n</ion-header>\n\n\n<ion-content  padding>\n  <ion-item>\n      <ion-label padding color=\'deep\'>\n          <ion-icon color=\'primary\' name="ios-happy"></ion-icon>\n          {{lp.translate()[0].lang}}\n      </ion-label>\n      <ion-select [(ngModel)]="gender" (ionChange)="onSelectChange($event)">\n          <ion-option  value="en" selected>English</ion-option>\n          <ion-option  value="fr">French</ion-option>\n          <ion-option  value="ar">Arabic</ion-option>\n          <ion-option  value="kr">Kurdish</ion-option>\n          <ion-option  value="rs">Russian</ion-option>\n          <ion-option  value="az">Azerbaijani</ion-option>\n          <ion-option  value="pr">Portuguese</ion-option>\n      </ion-select>\n    </ion-item>\n</ion-content>\n'/*ion-inline-end:"/Users/chineduetoh/Desktop/VSCODE PROJECTS/Metro/User/src/pages/settings/settings.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_2__providers_language_language__["a" /* LanguageProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], SettingsPage);
