...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__promo__ = __webpack_require__(508);
...
PromoPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__promo__["a" /* PromoPage */]),
        ],
        entryComponents: [
            __WEBPACK_IMPORTED_MODULE_2__promo__["a" /* PromoPage */]
        ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_http__ = __webpack_require__(299);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_pop_up_pop_up__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_event_event__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_profile_profile__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_social_sharing__ = __webpack_require__(300);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PromoPage = (function () {
    function PromoPage(ph, http, share, lp, pop, eProvider, platform, nav, navParams, loadingCtrl, alertCtrl, settings, formBuilder) {
        ...
        this.ph.getUserProfile().on('value', function (userProfileSnapshot) {
            if (userProfileSnapshot.val()) {
                _this.earnings = userProfileSnapshot.val().refEarning;
    ...
    PromoPage.prototype.gotoEarning = function () {
