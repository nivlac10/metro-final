...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__payment__ = __webpack_require__(504);
...
var PaymentPage = (function () {
    function PaymentPage(ph, set, lp, navCtrl, navParams) {
        this.ph = ph;
        this.set = set;
        this.lp = lp;
    ...
    PaymentPage.prototype.Promo = function () {
        this.navCtrl.push('ReferalcodePage');
    };
    return PaymentPage;
}());
PaymentPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-payment',template:/*ion-inline-start:"/Users/chineduetoh/Desktop/VSCODE PROJECTS/Metro/User/src/pages/payment/payment.html"*/'<!--\n  Generated template for the PaymentPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header no-border>\n\n  <ion-navbar color="nav-color">\n    <ion-title>{{lp.translate()[0].payment2}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="no-scroll" padding>\n    <ion-list padding radio-group [(ngModel)]="paymentType">\n       \n        <button detail-none no-lines ion-item block id=\'iten\' color="primary">\n          <ion-label [hidden]="ph.card != null"> <ion-icon  color=\'nav-color\' padding name="ios-card">\n          </ion-icon> {{lp.translate()[0].addcard}} </ion-label>\n          <ion-label [hidden]="ph.card == null" > <ion-icon  color=\'nav-color\' padding name="ios-card">\n          </ion-icon > {{cardnumber}} </ion-label>\n          <ion-radio color="nav-color" value="card" (click)="gotoCard()" ></ion-radio>\n        </button>\n    \n        <ion-label text-center>\n            \n              </ion-label>\n      <button *ngIf=\'set.refer\' detail-none no-lines ion-item block id=\'iten\' color="newColor" (click)="Promo()">\n          <ion-label >\n              <ion-icon color=\'nav-color\' padding name="ios-trophy">\n              </ion-icon>\n              Enter A Referal Code.\n            </ion-label>\n        </button>\n\n      </ion-list>\n      \n</ion-content>\n'/*ion-inline-end:"/Users/chineduetoh/Desktop/VSCODE PROJECTS/Metro/User/src/pages/payment/payment.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__providers_profile_profile__["a" /* ProfileProvider */], __WEBPACK_IMPORTED_MODULE_4__providers_settings_settings__["a" /* SettingsProvider */], __WEBPACK_IMPORTED_MODULE_3__providers_language_language__["a" /* LanguageProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
], PaymentPage);
